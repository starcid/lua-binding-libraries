#ifndef HASH_HAVAL4_H_
#define HASH_HAVAL4_H_
...
class CHAVAL4 : public CHAVAL3<HAVAL_FPTLEN>, public CHavalUpdateFinal<CHAVAL4<HAVAL_FPTLEN> >
{
protected:
...
public:
	...
	{
		return CHavalUpdateFinal<CHAVAL4<HAVAL_FPTLEN> >::Update(pData, ulLen, CHAVAL3<HAVAL_FPTLEN>::m_context);
	}

	int Final(unsigned char * pszOut)
	{
		return CHavalUpdateFinal<CHAVAL4<HAVAL_FPTLEN> >::Final(pszOut, HAVAL_PASS, CHAVAL3<HAVAL_FPTLEN>::m_context, HAVAL_FPTLEN);
	}
};
